      ...
      <main className="mx-auto flex w-full max-w-3xl flex-1 flex-col gap-16 px-6 py-12">
        <section className="relative isolate flex flex-col items-center gap-6 text-center">
          ...
          <div className="flex flex-col items-center gap-4">
            <h1 className="font-heading text-4xl font-semibold tracking-tight text-balance">
              Your move. The coach is watching.
            </h1>
            <p className="max-w-xl text-lg text-muted-foreground text-pretty">
              This is the real thing, not a screenshot: play Maia, a human-like
              chess bot, right here. After each move, the gator — Stockfish
              under the hood — tells you what you played. No sign-up, nothing
              uploaded.
            </p>
          </div>
          <LandingHeroClient />
        ...
        <Reveal>
          <section className="flex flex-col items-center gap-3 text-center">
            ...
            <p className="text-muted-foreground">
              The full board adds the move timeline, hints, takebacks, and
              strength settings. Anything you started up there comes with you.
            </p>
