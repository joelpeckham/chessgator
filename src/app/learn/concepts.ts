...
export const CONCEPTS: readonly Concept[] = [
  ...
  },
  {
    ...
    fen: "8/8/3k4/4p3/3KP3/8/8/8 w - - 0 1",
    highlights: ["d4", "d6", "e4", "e5"],
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "The h-pawn promotes on h8, a dark square. The bishop on f1 is light-squared. If Black’s king gets to h8 and stays there, White cannot force it out.",
